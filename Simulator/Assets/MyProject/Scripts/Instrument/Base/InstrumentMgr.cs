...
public class InstrumentMgr : MonoBehaviour
{
    ...
    private string GetInstrumentResPath(InstrumentEnum instrumentEnum)
    {
        switch (instrumentEnum)
        {
            ...
            case InstrumentEnum.枕头2:
                return "Instruments/床/枕头2";
            case InstrumentEnum.床1:
                return "Instruments/床/床1";
            case InstrumentEnum.床2:
                return "Instruments/床/床2";
            #endregion
            ...
            case InstrumentEnum.餐桌1:
                return "Instruments/桌子/餐桌1";
            case InstrumentEnum.圆桌1:
                return "Instruments/桌子/圆桌1";
            case InstrumentEnum.圆桌2:
                return "Instruments/桌子/圆桌2";
            #endregion
            ...
            case InstrumentEnum.餐椅1:
                return "Instruments/椅子/餐椅1";
            case InstrumentEnum.沙发1:
                return "Instruments/椅子/沙发1";
            case InstrumentEnum.沙发2:
                return "Instruments/椅子/沙发2";
            case InstrumentEnum.沙发3:
                return "Instruments/椅子/沙发3";
            #endregion
            ...
            case InstrumentEnum.冰箱1:
                return "Instruments/电器/冰箱1";
            case InstrumentEnum.吊扇1:
                return "Instruments/电器/吊扇1";
            #endregion
            ...
            case InstrumentEnum.台灯1:
                return "Instruments/灯饰/台灯1";
            #endregion
            ...
            case InstrumentEnum.WallDecorate1:
                return "Instruments/其他/墙沿1";
            case InstrumentEnum.WallDecorate2:
                return "Instruments/其他/墙沿2";
            #endregion
